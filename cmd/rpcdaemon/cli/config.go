...
import (
	...
	"github.com/tenderly/erigon/erigon-lib/kv/remotedb"
	...
	"github.com/tenderly/erigon/cmd/rpcdaemon/graphql"
	"github.com/tenderly/erigon/cmd/rpcdaemon/health"
...
func RootCommand() (*cobra.Command, *httpcfg.HttpCfg) {
	...
	rootCmd.PersistentFlags().StringSliceVar(&cfg.API, "http.api", []string{"eth", "erigon"}, "API's offered over the RPC interface: eth,erigon,web3,net,debug,trace,txpool,db. Supported methods: https://github.com/tenderly/erigon/tree/devel/cmd/rpcdaemon")
