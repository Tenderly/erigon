...
with open('/Users/alexeyakhunov/workspace/src/github.com/idrecun/erigon/badger.log') as f:
    lines = f.readlines()
...
with open('/Users/alexeyakhunov/workspace/src/github.com/idrecun/erigon/badger.csv', 'w') as w:
