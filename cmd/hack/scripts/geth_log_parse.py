...
with open('/Users/alexeyakhunov/workspace/src/github.com/tenderly/erigon/badger.log') as f:
    lines = f.readlines()
...
with open('/Users/alexeyakhunov/workspace/src/github.com/tenderly/erigon/badger.csv', 'w') as w:
